...
<meta http-equiv="refresh" content="2;url=../production/formLot.php?med=<?php echo $_GET['med'];?>" />
<?php } ?>
        ...
        <div class="right_col" role="main">
         <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                   ...
                   <div class="x_panel">
				 <div class="x_content"> 
				   <h2 style=" text-align: center; text-transform: uppercase;  color:#23798E ;"> Etats des sorties pour un médicament</h2>
                
                 <br/>
				 <br/>				 
				               
                    <form id="demo-form2"  class="form-horizontal form-label-left" action="../../control/test1control.php" method="post"  >
					 ...
					 <div class="col-sm-7">
					 	  ...
					 	  <?php 
								 if(isset($_GET["med"])){
								  ...
								  $rqt="SELECT * FROM medicaments WHERE num_med=$n and num_med in (SELECT num_med FROM echantillon WHERE num_echant in (SELECT num_lot From sortie_stock)) ORDER BY nom_med";
								   $rt="SELECT * FROM medicaments WHERE num_med!=$n  and num_med in (SELECT num_med FROM echantillon WHERE num_echant in (SELECT num_lot From sortie_stock)) ORDER BY nom_med";
								  //echo $rqt;
						...
						$res2 = mysqli_query($conn ,"SELECT * FROM medicaments WHERE num_med in (SELECT num_med FROM echantillon WHERE num_echant in (SELECT num_lot From sortie_stock)) ORDER BY nom_med");

...
<meta http-equiv="refresh" content="2;url=../production/formajoutmed.php" />
<?php } ?>
...
<br/>
        ...
        <div class="right_col" role="main">
         <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                   ...
                   <div class="x_panel">
				 <div class="x_content"> 
				   <h2 style=" text-align: center; text-transform: uppercase;  color:#23798E ;">Ajouter Un Médicament</h2>
                
                 <br/>
				 <br/>
				               
                    <form id="demo-form2"  class="form-horizontal form-label-left" action="../../control/ajoutmed.php" method="post"  >
				...
				<?php } ?>
                        ...
                        <label class="control-label  col-md-2 col-sm-2 col-xs-1 " >Nom du Médicament *:<span class="required"></span></label>
						  <div class="col-md-7 col-sm-1 col-xs-1  has-feedback">
                          <input type="text" id="nom_med"  class="form-control has-feedback-left " name="nom_med" required="required" style='border-radius: 5px;' onKeyUp="myFunction()">
						  <script>
	function myFunction() {
  ...
  x.value = x.value.toUpperCase();
						    ...
						    <div class="item form-group">
                        <label class="control-label  col-md-2 col-sm-2 col-xs-1">Dosage *:<span class="required"></span></label>
						<div class="col-md-5 col-sm-6 col-xs-12">
                       <input type="text" id="dosage" name="dosage"  class="form-control" required="required" style='border-radius: 5px;'>
                        
                      </div>
					  </div>
					  
                       <div class="item form-group">
                        <label class="control-label  col-md-2 col-sm-2 col-xs-1 ">Forme *:<span class="required"></span></label>
                     <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  class="form-control " type="text" id='Forme' name="Forme" required="required" style='border-radius: 5px;' onKeyUp="myFunction1()">
						    <script>
  ...
  x.value = x.value.toUpperCase();
                    ...
                    <div class="item form-group">
                        <label class="control-label  col-md-2 col-sm-3 col-xs-12 " >Presentation *:<span class="required"></span></label>
                    <div class="col-md-5 col-sm-6 col-xs-12">
                          <input class="form-control " type="text" name="p" required="required" style='border-radius: 5px;'>
                       </div>
                      </div>
					   <div class="item form-group">
                        <label  class="control-label  col-md-2 col-sm-3 col-xs-12 ">Primary packaging *:<span class="required" ></span></label>
                       <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  class="form-control" type="text" name="pkg" required="required" style='border-radius: 5px;' onKeyUp="myFunction2()" id='pkg'>
						    <script>
  ...
  x.value = x.value.toUpperCase();
	...
	<div class="col-md-6 col-offset-4">
				 <button type="submit" class=" btnn success " style='border-radius: 5px;'><i class="fa fa-plus-circle"></i> Ajouter un Médicament</button> 
				<?php  if(!isset($_GET['location'])){?> 
	<a href="formajoutmed.php"><button type="button" class=" btnn success " style='border-radius: 5px;'><i class="	fas fa-sync-alt"></i> Annuler</button></a>	 
	<?php } else {?>
<a href="formfacE.php?labo=<?php echo $_GET['labo']; ?>">	<button type="button"  class=" btnn success " style='border-radius: 5px;'><i class="	fas fa-sync-alt"></i> Annuler</button></a>	
	<?php } ?>				
</div>	    		
					  </div>	    
                   </div>     

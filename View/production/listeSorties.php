             ...
             <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel">
				   ...
				   <h2 style=" text-align: center; text-transform: uppercase;  color:#23798E ;"> Suivi des sorties des échantillons</h2>
...
$y="UPDATE auxiliere1 SET min='min' WHERE num_echant=$min";
  ...
  ?> 
		   ...
		   <div class="form-group row ">
			...
			<input value='<?php echo($total.' unités'); ?>' type='text' class="form-control has-feedback-left" style='border-radius: 5px;  background-color:#FFFFFF;'  readonly="readonly"/>
...
$fnct=$ligne[0];
			...
			$rt1=mysqli_query($cnx,$rt);
			 while($h= mysqli_fetch_array($rt1)){ $sum=$h[0].' unités'; }

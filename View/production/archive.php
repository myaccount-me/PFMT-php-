...
<br/>
		 ...
		 <div class="right_col" role="main">
             <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel">
				     <div class="x_content"> 
			  <h2 style=" text-align: center; text-transform: uppercase;  color:#23798E ;"> liste des entrées et des sorties des échantillons archivés</h2>	
			  <br/>	              
        ...
        <label class="control-label  col-md-2 col-sm-3 col-xs-3 has-feedback" style='font-size:12px'> Médicament:</label>
...
$y="UPDATE auxiliere1 SET min='min' WHERE num_echant=$min";
  ...
  ?> 
	...
	?>					 
	<br/>	
	<button type="button" class="bt success4" style='border-radius: 5px;padding:4px 22px; font-size:11px' disabled="disabled" ><span class='far fa-edit'> Liste des Entrées</span></button><br/>
 ...
 <thead style='text-align:center'>
  ...
  <th style='text-align:center' width="20%">Bl numéro</th>
 ...
 <thead style='text-align:center'>
  ...
  <th style='text-align:center' width="25%"><i class='fas fa-user-lock' ></i> Bénéfciaire</th>
